    ...
    void crear(int valor) {
        if (cabeza == nullptr) {
            ...
            if(cabeza == finLista){
                ...
                //o recorremos la lista para encontrar el elemento antes de cabeza oooo
                //implementamos el atributo anterior y encontramos el atributo anterior de cabeza y 
                //lo agregamos ahi. 
            }
        }
        tamanio++;
